...
REVISED_VOCABULARY = [
    "傷病者発見", "周囲の安全よし", "感染防御", "手袋", "大丈夫ですか",
    "誰か来てください", "119番通報", "救急車", "AED", "必ず戻ってきてください",
    "呼吸の確認", "呼吸なし", "脈の確認", "脈なし", "頸動脈", "胸骨圧迫",
    "AEDを使えますか", "胸骨圧迫を交代", "合図", "離れてください", "電気ショック",
    "胸骨圧迫再開", "救急隊", "経緯", "引き継ぎ", "荷物", "かばん", "気道確保", "人工呼吸",
]
